...
# QQ: How do I wrap db calls in a function and call it once at program
# initiation?
...
def linkedin_connect():
    ...
    if login_session['state'] != state:
        # QQ: Why use JSON format in make_response?
    ...
    # QQ: Why is it that I don't need a "request", to receive HTTP post call?
    # I just use JSON() on "requests" for sending HTTP request.
